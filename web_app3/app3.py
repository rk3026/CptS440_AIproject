            ...
            dcc.Tabs(id="tabs", children=[  
                ...
                dcc.Tab(label='Yelp Reviews Analysis', children=[  
                    dbc.Card([  
                        ...
                        dbc.CardBody([  
                            dcc.Input(id="yelp-business-input", placeholder="Enter Yelp Business Name", type="text", style={'width': '100%'}),
                            
                            # Country Dropdown (optional, but will filter available states)
                            dbc.Row([
                            ...
                            # State Dropdown (only shown if a country is selected)
                            dbc.Row([
                                dbc.Col(dcc.Dropdown(
                                    id="state-dropdown",
                            ...
                            dcc.Dropdown(id="business-suggestions", style={'width': '100%', 'display': 'none'}),
